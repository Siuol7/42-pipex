...
SRCS = ./execution/mandatory/pipex.c ./execution/mandatory/pipex_utils.c ./execution/mandatory/pipex_exec.c\
		./execution/mandatory/main.c ./execution/mandatory/pipex_error.c ./execution/mandatory/pipex_check.c\
		 ./execution/mandatory/pipex_quote_dquote.c ./execution/mandatory/pipex_split_sh.c  ./execution/mandatory/pipex_splitting_sh.c
...
BONUS = ./execution/bonus/pipex_bonus.c ./execution/bonus/pipex_utils_bonus.c ./execution/bonus/pipex_exec_bonus.c\
		...
		./execution/bonus/pipex_check_bonus.c ./execution/bonus/pipex_quote_dquote_bonus.c ./execution/bonus/pipex_split_sh_bonus.c\
		./execution/bonus/pipex_splitting_sh_bonus.c
# Source Object files
OBJS = ${SRCS:.c=.o}
